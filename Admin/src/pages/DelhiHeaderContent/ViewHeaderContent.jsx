...
import { getHeader } from "../../Features/actions/delhiHeader";

const ViewDelhiHeaderContent = () => {
      ...
      <div className="max-w-screen-xl mt-10 mx-auto px-4 md:px-8">
        <div className="items-start justify-between md:flex">
          ...
          <div className="mt-3 md:mt-0">
            <a
              onClick={() => {
                navigate(`/updateDelhiHeader/${headerData[0]?._id}`);
              }}
...
export default ViewDelhiHeaderContent;
