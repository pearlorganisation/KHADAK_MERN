...
import { createFooter} from '../../Features/actions/delhiFooter';
import { ClipLoader } from 'react-spinners';

import { clearSuccessFooterState } from '../../Features/slices/delhiFooter';



const CreateDelhiFooterContent = () => {
 
  const dispatch = useDispatch();
  const navigate = useNavigate();
const {isLoading,isSuccess}= useSelector((state)=>state.delhiFooter)
...
export default CreateDelhiFooterContent