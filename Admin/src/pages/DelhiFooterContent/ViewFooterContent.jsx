...
import { deleteFooter, getFooter } from '../../Features/actions/delhiFooter';
...
const ViewDelhiFooterContent = () => {
    const navigate = useNavigate();
    const dispatch = useDispatch();
    const { footerData, isDeleted, isLoading } = useSelector((state) => state.delhiFooter);
              ...
              <Stack spacing={4}>
               ...
               Array.isArray(footerData) && footerData?.map((item, idx) => (
                  <tr key={idx}>
                    ...
                    <a
                       onClick={() => {
                        navigate(`/updateDelhiFooter/${item?._id}`, { state: item  });
                      }}  
...
export default ViewDelhiFooterContent