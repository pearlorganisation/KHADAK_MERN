...
import { updateFooter } from '../../Features/actions/delhiFooter';
import { clearSuccessFooterState } from '../../Features/slices/delhiFooter';
import { ClipLoader } from 'react-spinners';


const UpdateDelhiFooterContent = () => {
  const { state: item } = useLocation();
  const { isSuccess, isLoading } = useSelector((state) => state.delhiFooter);
  const {id} = useParams()
...
export default UpdateDelhiFooterContent